    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Listening and playing music", "Music" },
                    { 2, "Programming and learning new tech", "Coding" },
                    { 3, "Reading novels and poetry", "Reading" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "https://spotify.com" },
                    { 2, 2, 1, "https://github.com" },
                    { 3, 3, 1, "https://bokus.se" },
                    { 4, 3, 2, "https://bokus.se" }
                });
